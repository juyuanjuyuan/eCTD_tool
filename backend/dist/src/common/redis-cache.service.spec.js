...
describe('RedisCacheService', () => {
    ...
    let mockClient;
    beforeEach(() => {
        service = new redis_cache_service_1.RedisCacheService();
        mockClient = {
            status: 'ready',
    ...
    describe('set', () => {
        it('should set value with TTL', async () => {
            ...
            expect(mockClient.set).toHaveBeenCalledWith('key', JSON.stringify({ data: 'value' }), 'EX', 300);
        });
    ...
    describe('setnx', () => {
        it('should return true when key was set', async () => {
            ...
            expect(mockClient.set).toHaveBeenCalledWith('lock:key', JSON.stringify({ user: '1' }), 'EX', 30, 'NX');
        });
...
//# sourceMappingURL=redis-cache.service.spec.js.map