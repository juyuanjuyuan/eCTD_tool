...
export declare class PackageAssemblerService {
    ...
    constructor(prisma: PrismaService, cnRegionalXml: CnRegionalXmlService, indexXml: IndexXmlService, md5Service: Md5Service, validator: ValidatorService, minioService?: MinioService | undefined);
