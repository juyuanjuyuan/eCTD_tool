...
function buildModule2Leaf(overrides = {}) {
    return {
...
function buildSequenceMock(overrides = {}) {
    return {
        id: 'seq1',
        sequenceNumber: '0000',
...
describe('XML Backbone Validation', () => {
    describe('index.xml structural validation', () => {
        ...
        beforeEach(() => {
            ...
            service = new index_xml_service_1.IndexXmlService(mockPrisma, md5Service);
            jest.clearAllMocks();
        ...
        it('should correctly nest multi-level elements', async () => {
            ...
            const leafPos = xml.indexOf('m3/32-body-data/s-general.pdf');
    ...
    describe.skip('STF XML structural validation (Plan 12 — moved to study-tagging-file.service.spec.ts)', () => {
        ...
        it('should reference ich-stf-v2-2.dtd DTD', () => {
            const xml = stfService.generateStfXml({ studyTitle: '研究报告', studyId: 'STUDY-001' }, { fileAttachments: [] });
        ...
        it('should include study-identifier with title and id', () => {
            const xml = stfService.generateStfXml({ studyTitle: '药理学研究报告', studyId: 'PHARM-2026-001' }, { fileAttachments: [] });
        ...
        it('should include file references in study-document when files exist', () => {
            const xml = stfService.generateStfXml({ studyTitle: '研究报告', studyId: 'S-1' }, {
                fileAttachments: [
...
//# sourceMappingURL=xml-backbone-validation.spec.js.map