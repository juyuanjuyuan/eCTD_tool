...
describe('EditLockController', () => {
    ...
    beforeEach(() => {
        ...
        controller = new edit_lock_controller_1.EditLockController(service, assignmentService);
    });
    ...
    it('should reject lock when no EDIT permission', async () => {
        ...
        await expect(controller.acquireLock('node-1', { id: 'user-1', name: '张三' })).rejects.toThrow('您对此章节没有编辑权限');
    });
...
//# sourceMappingURL=edit-lock.controller.spec.js.map