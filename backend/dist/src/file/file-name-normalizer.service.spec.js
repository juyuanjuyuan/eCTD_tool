...
describe('FileNameNormalizerService', () => {
    let service;
    beforeEach(() => {
        service = new file_name_normalizer_service_1.FileNameNormalizerService();
    });
    ...
    describe('validateExtension', () => {
        ...
        it('should reject .docx files', () => {
            expect(() => service.validateExtension('report.docx')).toThrow(common_1.BadRequestException);
        });
        it('should reject .jpg files', () => {
            expect(() => service.validateExtension('photo.jpg')).toThrow(common_1.BadRequestException);
        });
    ...
    describe('validateFileSize', () => {
        ...
        it('should reject normal files over 500MB', () => {
            expect(() => service.validateFileSize(501 * 1024 * 1024, 'report.pdf')).toThrow(common_1.BadRequestException);
        });
        ...
        it('should reject XPT files over 4GB', () => {
            ...
            expect(() => service.validateFileSize(overFourGB, 'data.xpt')).toThrow(common_1.BadRequestException);
        });
    ...
    describe('buildEctdRelativePath', () => {
        ...
        it('should throw when any path segment exceeds 64 characters', () => {
            ...
            expect(() => service.buildEctdRelativePath('1.2', longName)).toThrow(common_1.BadRequestException);
        });
        it('should accept a compliant 230-char eCTD path (ICH eCTD v3.2.2)', () => {
            const name = 'report-' + 'a'.repeat(50) + '.pdf';
    ...
    describe('validatePathSeparators', () => {
        ...
        it('should reject backslashes', () => {
            expect(() => service.validatePathSeparators('m1\\cn\\02\\form.pdf')).toThrow(common_1.BadRequestException);
        });
    });
});
//# sourceMappingURL=file-name-normalizer.service.spec.js.map