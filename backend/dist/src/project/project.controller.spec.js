...
describe('ProjectController', () => {
    ...
    beforeEach(() => {
        ...
        controller = new project_controller_1.ProjectController(service);
    });
    it('should create project', async () => {
        const result = await controller.create({ name: '测试' }, 'user-1');
        expect(service.create).toHaveBeenCalledWith({ name: '测试' }, 'user-1');
    });
    it('should find all projects', async () => {
        await controller.findAll({ page: 1, pageSize: 20 }, 'user-1');
    ...
    it('should update project', async () => {
        await controller.update('proj-1', { name: '新名称' }, 'user-1');
    ...
    it('should add member', async () => {
        await controller.addMember('proj-1', { userId: 'u2', role: 'MEMBER' }, 'user-1');
